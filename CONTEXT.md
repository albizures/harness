...
Harness is a collection of small Pi packages maintained in this repository. This root context contains shared repository vocabulary; package-specific and skill-catalog vocabulary lives in the contexts listed by `CONTEXT-MAP.md`.

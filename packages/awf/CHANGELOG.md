...
- 8c6eed4: Add public agent-workflow Wayfinder and Grilling lifecycle commands, including input-preserving success logs and discoverable help/describe usage.
...
- 4f12d35: Align the bundled agent workflow skills with the public AWF Spec, Task, Wayfinder, and Grilling command surface.
...
- aecbe32: Infer GitHub issue parent relationships from native sub-issue lists so GitHub-backed AWF creation verification and readiness honor native sub-issues and dependencies.
